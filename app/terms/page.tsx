        ...
        <div className="space-y-8 max-w-3xl">
            ...
            <section className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    <li>Access and browse the Website for personal, educational, or professional use</li>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    <li>Republish, redistribute, or sell the content without permission</li>
            ...
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    <strong>This website is provided "as is" without any warranties, express or implied.</strong>
                </p>
                <ul className="list-disc pl-6 space-y-2  text-muted-foreground">
                    <li>We make no guarantees about the accuracy, completeness, or timeliness of the content</li>
                    <li>Content may contain errors, omissions, or outdated information</li>
            ...
            <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    ...
                    organization, and presentation are protected by applicable intellectual
                    property laws.
                </p>
            </section>
